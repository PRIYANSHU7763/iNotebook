...
const Notes = (props) => {
  ...
  const handleclick = (e) => {
    ...
    showAlert("Deleted Successfull", "success")
  ...
  return (
    <>
      ...
      <div className="row my-3">
        <h2>Your Notes</h2>
        <div className="containern mx-2">
          {notes.length === 0 && "No Notes To Display"}
        </div>
        {/* // agar Koi Bhi Notes Meh Data Nahi Hoga The it Wiil Display No Notes To Display, We Write && If There Is No Else Conction */}
        {notes.map((note) => {
          return (
